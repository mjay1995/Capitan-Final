...
public class BarangayClearanceImpl extends DatabaseSource implements BarangayClearanceDatabase {
    ...
    @Override
    public BarangayClearance getBarangayClearance(String controlNo) throws ServiceException {
        ...
        try
        {
           ...
           PreparedStatement  ps = this.getConnection().prepareStatement(loadSql);
