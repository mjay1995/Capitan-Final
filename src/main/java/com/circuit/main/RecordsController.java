...
public class RecordsController implements Initializable {
    ...
    void editRow(MouseEvent event) throws ServiceException {
      ...
      barangayClearanceImpl.getBarangayClearance(recordTable.getSelectionModel().getSelectedItem().getControlNo());
      //control_no.setText(BarangayClearance.getControl_no());
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            barangayClearance.setBarangayName(UserContext.getCurrentBarangay());
            ...
            barangayClearance.setBarangayKag6(UserContext.getKAGAWAD_6());
              ...
              recordTable.setOnMousePressed(new EventHandler<MouseEvent>() {
                @Override
